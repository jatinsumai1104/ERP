                        ...
                        <div class="portlet light portlet-fit bordered">
                            <div class="portlet-title">
                                <div class="caption">
                                    ...
                                    <span class="caption-subject font-red sbold uppercase">Supplier</span>
                                </div>
                            </div>
                                            ...
                                            <form action="http://<?php echo BASE_SERVER;?>/erp/pages/scripts/supplier/edit.php" method="POST">
                                                <div class="form-body">
                                                    ...
                                                    <div class="form-group clearfix">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="text" id="supplier_address" name="supplier_address" class="form-control" placeholder="Supplier Adrress" /> </div>
                                                    </div>
                                                    <div class="form-group clearfix">
...
<![endif]-->
    ...
    <?php
         if(isset($_SESSION['status']) && ($_SESSION['status'] == SUPPLIER_EDIT_SUCCESS || $_SESSION['status'] == SUPPLIER_DELETE_SUCCESS)){
      ?>
    <script>
        toastr.options = {
            "closeButton": true,
        ...
        toastr["success"]("You have successfully changed", "Supplier Edit")
