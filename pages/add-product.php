                            ...
                            ?>
                                ...
                                ?>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label">Additional Specifications</label>
                                                    <div class="col-md-8">
...
<![endif]-->
    ...
    <!--END OF CUSTOM SCRIPT LOADING-->
     <?php
         if(isset($_SESSION['status']) && $_SESSION['status'] == PRODUCT_ADD_SUCCESS){
      ?>
      <script>
                  toastr.options = {
                    "closeButton": true,
         ...
         toastr["success"]("Product Added", "Product Adding")
      </script>
      <?php
