<?php
//THis is the php code for managing the tables in the manage-product page
...
//    $sub_array[] = $image_path;
    ...
    $sub_array[] = "<button class='edit fa fa-pencil btn blue' id='".$row['product_id']."' data-toggle='modal' data-target='#editModal'> EDIT</button>";
    $sub_array[] = "<button class='delete fa fa-trash btn red' id='".$row['product_id']."' data-toggle='modal' data-target='#deleteModal'> DELETE</button>";
