        ...
        <div class="page-content-wrapper">
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="portlet">
                            <a href="http://localhost/erp/pages/manage-customer.php" class="btn red">
      ...
      if($_GET['q']=="success"){
         ...
         if($_GET['status']=='customer'){
            echo"<div class='alert alert-danger'>
                 <button class='close' data-close='alert'></button>Already inserted in the Customer table </div>";
...
?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <textarea name="customer_address" class="form-control" cols="10" rows="5" placeholder="Customer Address"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input type="number" name="customer_contact" class="form-control" placeholder="Customer Phone" /> </div>
                                        </div>
                                        <div class="form-group">
