        ...
        <div class="page-content-wrapper">
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="portlet">
                            <a href="http://localhost/erp/pages/add-product.php" class="btn red">
                                            ...
                                            <form action="http://<?php echo BASE_SERVER;?>/erp/pages/scripts/product/edit.php" method="POST">
                                                <div class="form-body">
                                                    ...
                                                    <div class="form-group clearfix">
                                                        ...
                                                        <div class="col-md-9">
                                                            <textarea type="text" id="additional_specification" name="additional_specification" class="form-control" placeholder="Product Specification" id="" cols="10" rows="3"></textarea>
                                                            <br>
                                                        </div>
...
<![endif]-->
    ...
    <?php
         if(isset($_SESSION['status']) && ($_SESSION['status'] == PRODUCT_EDIT_SUCCESS || $_SESSION['status'] == PRODUCT_DELETE_SUCCESS)){
      ?>
    <script>
        toastr.options = {
            "closeButton": true,
        ...
        toastr["success"]("You have successfully changed", "Product Edit")
