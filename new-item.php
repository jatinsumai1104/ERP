...
<html lang="en">
  <head>
    ...
    <!-- Icons-->
    <link href="icons/coreui-icons-master/css/coreui-icons.min.css" rel="stylesheet">
    <link href="icons/flag-icon-css-master/css/flag-icon.min.css" rel="stylesheet">
    <link href="icons/font-awesome/css/font-awesome.min.css" rel="stylesheet">
    <link href="icons/simple-line-icons-master/css/simple-line-icons.css" rel="stylesheet">
  ...
  <body class="app header-fixed sidebar-fixed aside-menu-fixed sidebar-lg-show">
    ...
    <script src="js/src/charts.js"></script>
